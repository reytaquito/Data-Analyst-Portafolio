...
df_orders = pd.read_csv('../project 1/DataSets/departments.csv', sep=';')
df_products = pd.read_csv('../project 1/DataSets/products.csv', sep=';')
df_departments = pd.read_csv('../project 1/DataSets/departments.csv', sep=';')
df_order_products = pd.read_csv('../project 1/DataSets/order_products.csv', sep=';')
